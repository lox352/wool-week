  ...
  colourways: [
    {
      ...
      shades: [
        { slot: "A", name: "Pot-Pourri", code: "603", hex: "#af8f93", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-603" },
        { slot: "B", name: "Purple Heather", code: "239", hex: "#5f323a", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-239" },
        { slot: "C", name: "Foxglove", code: "273", hex: "#875373", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-273" },
        { slot: "D", name: "Prairie", code: "812", hex: "#4b6637", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-812" },
        { slot: "E", name: "Earth", code: "227", hex: "#393629", source: "library",
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "B", name: "Bright Pink", code: "8", hex: "#ff6566", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-8" },
        { slot: "C", name: "Bright Orange", code: "73", hex: "#d54400", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-73" },
        { slot: "D", name: "Light Blue", code: "14", hex: "#9ac4de", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-14" },
        { slot: "E", name: "Purpley Blue", code: "131", hex: "#5966b6", source: "library",
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "D", name: "Aetmeal (light fawn)", hex: "#f6efe3", source: "library",
