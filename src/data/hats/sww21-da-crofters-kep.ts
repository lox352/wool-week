  ...
  colourways: [
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Eclipse", code: "707", hex: "#2a283c", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-707" },
        { slot: "B", name: "Fjord", code: "170", hex: "#767b94", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-170" },
        { slot: "C", name: "Twilight", code: "175", hex: "#7e8596", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-175" },
        { slot: "D", name: "Pacific", code: "763", hex: "#576375", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-763" },
        { slot: "E", name: "Blueberry", code: "294", hex: "#4a3648", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-294" },
        { slot: "F", name: "Mist", code: "180", hex: "#b1abaf", source: "library",
    ...
    },
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Shetland Black", code: "2005", hex: "#4a3f3b",
        ...
        { slot: "C", name: "Dark Mixed Orange", code: "122", hex: "#9c4821",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-122" },
        { slot: "D", name: "Orange Rust Mix", code: "FC38", hex: "#94361b",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-fc38" },
        { slot: "E", name: "Dark Green", code: "82", hex: "#3a5d5a", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-82" },
        { slot: "F", name: "Bright Tan", code: "32", hex: "#c7641a", source: "library",
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "B", name: "Tormentil Heath", hex: "#d3a94e", source: "library",
        ...
        { slot: "F", name: "Moss", hex: "#d1d67c", source: "library",
