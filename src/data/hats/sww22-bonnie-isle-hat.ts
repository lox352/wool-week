  ...
  colourways: [
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Granite", code: "122", hex: "#aaaa9f", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-122" },
        { slot: "B", name: "Stonewash", code: "677", hex: "#324145", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-677" },
        { slot: "C", name: "Dove", code: "630", hex: "#595d5f", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-630" },
        { slot: "D", name: "Oxford", code: "123", hex: "#30302e", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-123" },
        { slot: "E", name: "Natural White", code: "104", hex: "#dbd6bb", source: "library",
    ...
    },
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Dark Teal Blue", code: "FC41", hex: "#0f2534",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-fc41" },
        { slot: "B", name: "Egg Yolk Yellow", code: "91", hex: "#a56805", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-91" },
        { slot: "C", name: "Marled Peachy Orange", code: "1281", hex: "#785b3b",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-1281" },
        { slot: "D", name: "Pale Lemon", code: "96", hex: "#b9a774", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-96" },
        { slot: "E", name: "Dark Red", code: "9113", hex: "#74181d", source: "library",
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "B", name: "Roanberry Meal", hex: "#c54a2b", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-roanberry-meal" },
        { slot: "C", name: "Roanberry Heath", hex: "#a04c38", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-roanberry-heath" },
        { slot: "D", name: "Graeff (Shetland black)", hex: "#352f30", source: "library",
    ...
    },
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Fern", hex: "#242a1e", source: "library",
          wool: "laxdale-2ply-fern" },
        { slot: "B", name: "Lichen", hex: "#deb459", source: "library",
          wool: "laxdale-2ply-lichen" },
        { slot: "C", name: "Buttermilk", hex: "#d2ac62", source: "library",
          wool: "laxdale-2ply-buttermilk" },
        { slot: "D", name: "Winter Sky", hex: "#c1ced6", source: "library",
          wool: "laxdale-2ply-winter-sky" },
        { slot: "E", name: "Artichoke", hex: "#5d5a47", source: "library",
    ...
    },
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Moonshine", hex: "#aab5a1", source: "library",
          wool: "aister-oo-2ply-jumper-weight-moonshine" },
        { slot: "B", name: "Cluve", hex: "#b19193", source: "library",
          wool: "aister-oo-2ply-jumper-weight-cluve" },
        { slot: "C", name: "Holsas", hex: "#5f3254", source: "library",
          wool: "aister-oo-2ply-jumper-weight-holsas" },
        { slot: "D", name: "Midsetter", hex: "#283777", source: "library",
          wool: "aister-oo-2ply-jumper-weight-midsetter" },
        { slot: "E", name: "Blinnd Moorie", hex: "#939b9d", source: "library",
