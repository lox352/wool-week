  ...
  colourways: [
    {
      ...
      shades: [
        ...
        { slot: "C", name: "Mid Fawn Green Mix", code: "FC64", hex: "#56483d",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-fc64" },
        { slot: "D", name: "Dark Fawn", code: "78", hex: "#6e5041", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-78" },
        { slot: "E", name: "Lavender", code: "FC21", hex: "#584b4f", source: "library",
    ...
    },
    {
      ...
      ballGrams: 25,
      shades: [
        { slot: "A", name: "Oxford", code: "123", hex: "#30302e", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-123" },
        { slot: "B", name: "Damask", code: "567", hex: "#775256", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-567" },
        { slot: "C", name: "Fog", code: "272", hex: "#a29488", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-272" },
        { slot: "D", name: "White", code: "304", hex: "#eae8de", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-304" },
        { slot: "E", name: "Rye", code: "140", hex: "#bcbb9e", source: "library",
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "B", name: "Flukkra (natural white)", hex: "#cdcfc1", source: "library",
        ...
        { slot: "D", name: "Speedwell", hex: "#5ab6e2", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-speedwell" },
        { slot: "E", name: "Moss Heath", hex: "#817b5c", source: "library",
