  ...
  colourways: [
    ...
    },
    {
      ...
      shades: [
        ...
        { slot: "B", name: "Laebrak (dark grey)", hex: "#a7c7e5", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-laebrak-dark-grey" },
        { slot: "C", name: "Graeff (Shetland black)", hex: "#5f5555", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-graeff-shetland-black" },
        { slot: "D", name: "Glansin (light grey)", hex: "#ebeae8", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-glansin-light-grey" },
        { slot: "E", name: "Moorit (Shetland brown)", hex: "#a09d9a", source: "library",
        ...
        { slot: "G", name: "Graeff (Shetland black)", hex: "#5f5555", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-graeff-shetland-black" },
