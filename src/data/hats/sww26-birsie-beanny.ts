  ...
  colourways: [
    {
      ...
      part: "1-2",
      shades: [
        { slot: "A", name: "Port Wine", code: "293", hex: "#2c1b20", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-293" },
        { slot: "B", name: "Cloud", code: "764", hex: "#a3bcbf", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-764" },
        { slot: "C", name: "Pacific", code: "763", hex: "#424b56", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-763" },
        { slot: "D", name: "Orchid", code: "547", hex: "#c0afaf", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-547" },
        { slot: "E", name: "Gentian", code: "710", hex: "#24223a", source: "library",
          wool: "jamieson-s-of-shetland-spindrift-710" },
        { slot: "F", name: "Lilac", code: "620", hex: "#a49dab", source: "library",
    ...
    },
    {
      ...
      part: "1-2",
      shades: [
        { slot: "A", name: "Dark Purple Mix", code: "FC14", hex: "#252229",
          source: "library", wool: "jamieson-smith-2ply-jumper-weight-fc14" },
        { slot: "B", name: "Salmon Pink", code: "9144", hex: "#923a31", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-9144" },
        { slot: "C", name: "Aubergine", code: "134", hex: "#652a3e", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-134" },
        { slot: "D", name: "Bright Orange", code: "73", hex: "#9a3005", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-73" },
        { slot: "E", name: "Dark Red Mix", code: "FC13", hex: "#210e0e", source: "library",
          wool: "jamieson-smith-2ply-jumper-weight-fc13" },
        { slot: "F", name: "Bright Turquoise", code: "71", hex: "#34968d",
    ...
    },
    {
      ...
      part: "3-4",
      shades: [
        { slot: "A", name: "Clover Heath", hex: "#436a53", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-clover-heath" },
        { slot: "B", name: "Sea Pink Heath", hex: "#b18fa7", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-sea-pink-heath" },
        { slot: "C", name: "Meadowsweet", hex: "#d6bb83", source: "library",
          wool: "uradale-yarns-2ply-jumper-weight-meadowsweet" },
        { slot: "D", name: "Moss", hex: "#989b5c", source: "library",
